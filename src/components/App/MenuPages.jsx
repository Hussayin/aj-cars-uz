...
const MenuAll = () => {
  return (
    <motion.div
      ...
      className=" font-bold bg-[#3b3b3b] border-[white] border-t-[3px] rounded-t-[17px] p-[13px] pb-[17px] fixed bottom-0 w-[100%] dark:text-white gap-[14px] z-[100000] flex items-center text-center"
    >
      {/* top watchs */}
      <NavLink
