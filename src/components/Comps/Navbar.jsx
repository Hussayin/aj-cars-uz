...
const Navbar = () => {
  ...
  return (
    <div className="w-full">
      {/* Navbar */}
      <div className=" z-[10000]  border-b-[2px] border-solid dark:border-black rounded-b-[20px] bg-[#000000] dark:bg-[#f4f1f1]  md:text-white dark:text-black flex justify-between py-[5px] items-center w-[100%] border-white px-[25px] md:px-[40px]  m-auto ">
        <div>
